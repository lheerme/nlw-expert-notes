...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md bg-zinc-800 text-left flex flex-col p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-zinc-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
